...
import com.project.myambulancedriver.R;
import com.project.myambulancedriver.interfaces.IPositiveNegativeListener;
...
public class UiHelper {
    ...
    private int getPrimaryColor() {
        return ContextCompat.getColor(context, R.color.clr_button);
    }
